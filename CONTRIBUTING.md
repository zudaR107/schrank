# Contributing to Schrank

Thanks for considering a contribution. Schrank is a file storage
service with nested folders and a pnpm workspace with two packages,
`backend/` and `frontend/` — please keep changes focused.
