...
// We store only the user id from the JWT - no passwords here. Folders
// and files land in a later stage once the file-storage feature itself
// is implemented; this stage is scaffolding only.
